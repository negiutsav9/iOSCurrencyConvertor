...
class RateTableViewController : UITableViewController, UISearchBarDelegate {
    ...
    var Array : [currencyRate] =
        [          currencyRate.init(currency: "AED    UAE Dirham", rate: 0.00),
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "RateCell", for: indexPath) as! TableViewCell
        let currency = Array[indexPath.row]
